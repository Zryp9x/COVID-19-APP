<template>
  <div class="container">
    <nav class="navbar-brand" style="width: 100%;">
        ...
        <button @click="$router.push('/countries').catch(err =>{})" type="button" class="btn btn-outline-dark" v-if="this.$route.path !== '/' && this.$route.path !== '/register' && this.$route.path !== '/countries'">Countries</button>
        <button @click="$router.push('/info').catch(err =>{})" type="button" class="btn btn-outline-dark" v-if="this.$route.path !== '/' && this.$route.path !== '/register' && this.$route.path !== '/info'">Info</button>
        <button @click="$router.push('/news').catch(err =>{})" type="button" class="btn btn-outline-dark" v-if="this.$route.path !== '/' && this.$route.path !== '/register' && this.$route.path !== '/news'">News</button>
        <button @click="$router.push('/authors').catch(err =>{})" type="button" class="btn btn-outline-dark" v-if="this.$route.path !== '/' && this.$route.path !== '/register' && this.$route.path !== '/authors'">Authors</button>
